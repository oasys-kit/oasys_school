...
a = numpy.loadtxt("power.spec",skiprows=23)
print(a.shape)
...
plot(a[:,0],a[:,4],
     ...
     a[:,0],a[:,4+6+5],
     a[:,0],a[:,4+6+5+5],
     xtitle="Photon Energy [eV]",ytitle="Transmittance",legend=["Attenuator Be 500 um","Mirror Rh 3mrad","Attenuator Al 50 um","Attenuator Mo 10 um"])
     
plot(a[:,0],a[:,1],
     a[:,0],a[:,6],
     a[:,0],a[:,6+6],
     ylog=True,xtitle="Photon Energy [eV]",ytitle="Spectral Power [W/eV]",legend=["Source","after attenuator Be 500 um","after Mirror Rh 3mrad"])